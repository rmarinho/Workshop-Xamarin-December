...
namespace Demo.Droid
{
	...
	public class MainActivity : Activity
	{
		protected override void OnCreate (Bundle bundle)
		{
			...
			//AIzaSyDgEo_NtYZxEjcgjaEOPsIJoZILmjPxiuw
		...
		/// <summary>
        /// Contains a list of house properties
        /// </summary>
        public List<HouseProperty> Properties { get; set; }
        ...
        private async void LoadData()
        {
			...
			this.Properties = await HousePropertyService.Default.LoadAsync (this.Resources.OpenRawResource (Resource.Raw.data));
		    // find the lsit view
            var listView = this.FindViewById<ListView>(Resource.Id.lstProperties);
            if (listView != null)
            {
                // set the adapter
                var adapter = new HousePropertyAdapter(this, this.Properties);
                ...
                listView.ItemClick += (s, e) =>
                {
                    ...
                    HousePropertyDetail.SelectedItem = this.Properties[e.Position];

                    // set the intent to navigate to it
                    var intent = new Intent(this, typeof(HousePropertyDetail));
                    ...
                    RunOnUiThread(() =>
                    {
                        ...
                        else
                        {
                            ...
                            map.Map.InfoWindowClick += (s, e) =>
                            {
                                ...
                                {
                                    // set the selected item
                                    HousePropertyDetail.SelectedItem = this.Properties[index];
